...
def save_as_image(filename: str, text: str,
    ...
    height = len(lines)
    width_coef = 9.65  # established experimentally
    height_coef = 15.65  # established experimentally
    image = Image.new("RGB", (int(width * width_coef), int(height * height_coef)),
...
def preview_window(text: str) -> None:
    ...
    layout = [[sg.In(default_text='white',
                     visible=False,
                     enable_events=True,
                     key='-BACKGROUND_COLOR-'),
               sg.ColorChooserButton('Background Color',
                                     target='-BACKGROUND_COLOR-'),
               sg.In(default_text='black',
                     visible=False,
                     enable_events=True,
                     key='-TEXT_COLOR-'),
               ...
               sg.Combo([*range(2, 16)],
                        ...
                        enable_events=True),
               sg.Push(),
               sg.InputText(visible=False,
                            enable_events=True,
                            key='-SAVE_IMAGE-'),
               sg.FileSaveAs('Save as Image',
                             target='-SAVE_IMAGE-',
    ...
    window = sg.Window("Result Art Preview",
                       layout,
                       modal=True,
                       font=('Arial', 14),
...
def main():
    ...
    sg.theme('DarkGrey5')
    original_art_column = [[sg.Text('Original Art (Editable)',
                                    justification="center",
                                    expand_x=True)],
                           [sg.Multiline(default_text=ascii_art.create_preview(),
                                         key='-ML_ORIGINAL-',
                                         size=(90, 50),
                                         font=('Courier', 6),
                                         enable_events=True,
                           ...
                           [sg.Input(key='-FILEBROWSE-',
                            ...
                            sg.Push(),
                            sg.Text('Width:'),
                            sg.Input(tooltip='Width image in chars',
                                     key='-WIDTH-',
                                     size=(3, 1),
                                     default_text='70',
                                     enable_events=True),
    ...
    result_art_column = [[sg.Push(),
                         ...
                         [sg.Checkbox('Add "exec"',
                          ...
                          sg.Checkbox('Fill',
                                      key='-FILL-',
                                      tooltip='Fills in missing characters',
                                      enable_events=True),
                          sg.Push(),
                          sg.Button('Preview',
                                    tooltip='Full size Preview in new window',
                                    key='-WINDOW-'),
                          sg.Push(),
    ...
    source_text_pan = [[sg.Text('Python code or text',
                                justification="center",
                                expand_x=True)],
                       [sg.Multiline(key='-ML_TEXT-',
                                     size=(100, 18),
                                     font=('Courier', 12),
                                     enable_events=True,
                                     expand_x=True,
